...
public class implParser extends Parser {
	...
	public static final int
		RULE_start = 0, RULE_commands = 1, RULE_command = 2, RULE_block = 3, RULE_condition = 4, 
		RULE_expr = 5;
	private static String[] makeRuleNames() {
		return new String[] {
			"start", "commands", "command", "block", "condition", "expr"
		};
	}
	...
	public final CommandsContext commands() throws RecognitionException {
		...
		try {
			...
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << T__2) | (1L << T__5) | (1L << IDENTIFIER))) != 0)) {
				{
				{
				setState(15);
				((CommandsContext)_localctx).command = command();
				((CommandsContext)_localctx).cmds.add(((CommandsContext)_localctx).command);
				}
				}
				setState(20);
				_errHandler.sync(this);
	...
	public static class WhileContext extends CommandContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof implListener ) ((implListener)listener).enterWhile(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof implListener ) ((implListener)listener).exitWhile(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof implVisitor ) return ((implVisitor<? extends T>)visitor).visitWhile(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public final CommandContext command() throws RecognitionException {
		...
		try {
			...
			case T__2:
				...
				match(T__3);
				setState(28);
				((WhileContext)_localctx).c = condition();
				setState(29);
				match(T__4);
				setState(30);
				((WhileContext)_localctx).b = block();
				}
				break;
			case T__5:
	...
	public static class MultiCommandContext extends BlockContext {
		public CommandsContext cs;
		public CommandsContext commands() {
			return getRuleContext(CommandsContext.class,0);
		}
		public MultiCommandContext(BlockContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof implListener ) ((implListener)listener).enterMultiCommand(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof implListener ) ((implListener)listener).exitMultiCommand(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof implVisitor ) return ((implVisitor<? extends T>)visitor).visitMultiCommand(this);
			else return visitor.visitChildren(this);
		}
	}
	public static class SingleCommandContext extends BlockContext {
		public CommandContext c;
		public CommandContext command() {
			return getRuleContext(CommandContext.class,0);
		}
		public SingleCommandContext(BlockContext ctx) { copyFrom(ctx); }
		@Override
		public void enterRule(ParseTreeListener listener) {
	...
	public final BlockContext block() throws RecognitionException {
		...
		try {
			...
			switch (_input.LA(1)) {
			case T__6:
				_localctx = new MultiCommandContext(_localctx);
				enterOuterAlt(_localctx, 1);
				{
				setState(40);
				match(T__6);
				setState(41);
				((MultiCommandContext)_localctx).cs = commands();
				setState(42);
				match(T__7);
				}
				break;
